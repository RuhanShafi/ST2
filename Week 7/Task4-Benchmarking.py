"""
Task 4: Benchmarking AVL Tree with Binary Search Trees (BSTs)
Includes enhanced visualisation for different data sizes using matplotlib.
"""
...
# ===== Enhanced Visualisation for Different Data Sizes =====
...
if __name__ == "__main__":
    # Run standard Tkinter GUI benchmark
    root = tk.Tk()
    app = BenchmarkApp(root)
    root.mainloop()

    # Run enhanced multi-size benchmark with matplotlib visualisation
    # Standard sizes (as per original task)
    sizes_to_test = [100, 200, 400, 800, 1600]
    print("\n=== Benchmark for sizes:", sizes_to_test, "===")
    run_benchmark_for_sizes(sizes_to_test)

    # Extended sizes up to ~10000 (as per task extension)
    sizes_extended = [500, 1000, 2000, 4000, 6000, 8000, 10000]
    print("\n=== Extended Benchmark for sizes:", sizes_extended, "===")
    run_benchmark_for_sizes(sizes_extended)